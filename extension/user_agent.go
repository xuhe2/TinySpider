...
func SetRandUserAgent(req *http.Request) error {
	req.Header.Set("User-Agent", uaGens[rand.Intn(len(uaGens))]())
	return nil
}

func SetRandMobileUserAgent(req *http.Request) error {
	req.Header.Set("User-Agent", uaGensMobile[rand.Intn(len(uaGensMobile))]())
	return nil
}
